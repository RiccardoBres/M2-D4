...
*/
 ...
 for (somma=0; somma < num.length; somma++){
  console.log (num[somma]+1)
 }*/
...
*/
/*for (title=0; title<=movies.length; title++) 
...
/*for (let mill = 0; mill < 14; mill++) {
 if (movies[mill].Year>2000) 
 {console.log (movies[mill].Title)};
} */
...
/*let x= 0
for (let sommaAnni = 0; sommaAnni<movies.length; sommaAnni++){
 x += (parseInt(movies[sommaAnni].Year));}
